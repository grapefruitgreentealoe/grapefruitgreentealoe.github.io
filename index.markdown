...
<div class="content">
  ...
  <section id="skills">
    ...
    <ul>
      <li><strong>Frontend</strong>: React, TypeScript, Vite, <strong>Next.js</strong>, Zustand, Jotai, React Query, Zod, Tailwind CSS, Shadcn UI, Storybook</li>
